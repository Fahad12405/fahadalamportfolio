...
const tech = () => {
  const data = [
    ...
    },
    {
      ...
      desc: " Node.js is a server-side platform built on Chrome's V8 JavaScript engine, allowing JavaScript to be executed outside the browser.",
      tag: "package manager",
      bg: "bg-gray-900",
      text: "text-gray-100",
    },
    {
      title: "Ant Design",
      id: 9,
      main: "/icons/ant-design-icon.png",
      desc: "Ant Design Icons provide a comprehensive set of icons designed for use with Ant Design, a popular React UI library. Here’s a concise overview:",
      tag: "Library",
      bg: "bg-orange-500",
